...
public class TemplateResource implements IResource
{
    ...
    {
        this.id = id;
        this.data = ProxyHolder.getInstance().getLoaderManager().loadData(IProxy.getInstance().getDefinitionLoaderManager().getLoaderFor(dataLocation).getGuiDefinition(dataLocation));
    }
