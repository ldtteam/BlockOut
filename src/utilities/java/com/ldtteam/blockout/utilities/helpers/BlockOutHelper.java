...
public class BlockOutHelper
{
     ...
     */
    private static Consumer<TemplateInstance.TemplateInstanceConstructionDataBuilder> initiatePlayerInventoryControlForRange(@NotNull final EntityPlayerMP entityPlayer, @NotNull final ResourceLocation inventoryId, @NotNull final ResourceLocation slotResource, final int width, final int minSlot, final int maxSlot)
    {
     ...
     * @return the finished data builder.
     */
    private static Consumer<TemplateInstance.TemplateInstanceConstructionDataBuilder> initiateStandardInventoryWithItemHandler(@NotNull final IItemHandler handler, @NotNull final ResourceLocation inventoryId, @NotNull final ResourceLocation slotResource, final int width)
    {
     ...
     */
    public static void initiateChestControlAtPosition(@NotNull final IBlockOutGuiConstructionDataBuilder theBuilder, @NotNull final World world, @NotNull final String controlId, @NotNull final BlockPos chestPosition, @NotNull final ResourceLocation inventoryId, @NotNull final ResourceLocation slotResource)
    {
        theBuilder.withControl(
          controlId,
          TemplateInstance.TemplateInstanceConstructionDataBuilder.class,
          initiateStandardInventoryWithItemHandler(world.getTileEntity(chestPosition).getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null), inventoryId, slotResource, 9)
        );
    }
     ...
     */
    public static void initiatePlayerInventoryControl(@NotNull final IBlockOutGuiConstructionDataBuilder theBuilder, @NotNull final String controlId, @NotNull final EntityPlayerMP entityPlayer, @NotNull final ResourceLocation inventoryId, final int minSlot, final int maxSlot, @NotNull final ResourceLocation slotResource)
    {
        theBuilder.withControl(
          controlId,
          TemplateInstance.TemplateInstanceConstructionDataBuilder.class,
