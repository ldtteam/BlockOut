package com.minecolonies.blockout.util.keyboard;
...
public enum KeyboardKey
{
    ...
    private static final Map<Integer, KeyboardKey> mappings = new HashMap<>();
    static
    {
        Arrays.stream(KeyboardKey.values()).forEach(k -> mappings.put(k.code, k));
    }
    private final int code;

    KeyboardKey(final int code)
    {
        this.code = code;
    }

    public static KeyboardKey getForCode(final int code)
    {
