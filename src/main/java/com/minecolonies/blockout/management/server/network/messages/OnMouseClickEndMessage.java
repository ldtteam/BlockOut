...
public class OnMouseClickEndMessage implements IBlockOutServerToClientMessage
{
    @NotNull
    ...
    public void onMessageArrivalAtClient(@NotNull final MessageContext ctx)
    {
        ...
        if (openGuiScreen instanceof BlockOutGui)
        {
            ...
            blockOutGui.getRoot().getUiManager().getClickManager().onMouseClickEnd(localX, localY, button);
        }
        else
        {
