...
public class OnMouseScrollMessage implements IBlockOutClientToServerMessage
{
    @NotNull
    ...
    public void onMessageArrivalAtServer(@NotNull final MessageContext ctx)
    {
        ...
        rootGuiElement.getUiManager().getScrollManager().onMouseScroll(localX, localY, deltaScroll);
    }
}
