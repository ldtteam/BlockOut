...
public class ProgressBar extends AbstractSimpleUIElement implements IDrawableUIElement
{
    ...
    public void drawBackground(@NotNull final IRenderingController controller)
    {
        ...
        RenderSystem.scaled(backgroundScalingFactor.getX(), backgroundScalingFactor.getY(), 1);
        ...
        RenderSystem.scaled(foregroundScalingFactor.getX(), foregroundScalingFactor.getY(), 1d);
